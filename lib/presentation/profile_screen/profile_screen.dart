                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Opacity(
                                      opacity: 0.8,
                                      child: Text(
                                        "msg_felicia_reid_example_com".tr,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "lbl_edit".tr,
                                  style:
                                      CustomTextStyles.bodyLargeInterOrange600,
                                ),
                              ),
                            ],
                          ),
    ...
    return Row(
      ...
      children: [
        Opacity(
          ...
          child: Text(
            phoneNumber,
            style: CustomTextStyles.bodyLargeInterBlack90018.copyWith(
        ...
        Text(
          editText,
          style: CustomTextStyles.bodyLargeInterOrange600.copyWith(
